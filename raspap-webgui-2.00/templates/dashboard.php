...
$ifaceStatus = $rmnet_data0up ? "up" : "down";
?>
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-body">
          ...
          <div class="col-md-6 mb-3">
            <div class="card h-100">
              <div class="card-body wireless">
				...
				<h4> <?php echo _("Singal Information"); ?></h4>
				<div class="info-item"><?php echo _("Radio:"); ?></div><div>  <?php echo htmlspecialchars($connectedRadio, ENT_QUOTES); ?></div>
			  
				<div class="info-item"><?php echo _("SNR:"); ?></div><div>  <?php echo htmlspecialchars($snr, ENT_QUOTES); ?></div>
	    ...
	    <div class="card mb-3">
              <div class="card-body">
                ...
                <div class="info-item"><?php echo _("Interface Name"); ?></div><div><?php echo RASPI_RMNET_DATA0_INTERFACE; ?></div>
...
<!--BUTTON-->
          ...
          <div class="row">
            <form action="?page=wlan0_info" method="POST">
                ...
                <?php if (!RASPI_MONITOR_ENABLED) : ?>
                    <?php if (!$rmnet_data0) : ?>
                    <input type="submit" class="btn btn-success" value="<?php echo _("Start").' '.RASPI_RMNET_DATA0_INTERFACE ?>" name="ifup_wlan0" />
                    <?php else : ?>
                    <input type="submit" class="btn btn-warning" value="<?php echo _("Stop").' '.RASPI_RMNET_DATA0_INTERFACE ?>"  name="ifdown_wlan0" />
                    <?php endif ?>
                <?php endif ?>
      ...
      <div class="card-footer"><?php echo _("Information provided by ip and ifconfig and from system"); ?></div>
    </div><!-- /.card -->
  </div><!-- /.col-lg-12 -->
</div><!-- /.row -->
